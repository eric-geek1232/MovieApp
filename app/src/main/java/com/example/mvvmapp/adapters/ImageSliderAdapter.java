...
import com.example.mvvmapp.databinding.ItemContainerSliderImageBinding;
...
public class ImageSliderAdapter extends RecyclerView.Adapter<ImageSliderAdapter.ImageSliderViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ImageSliderViewHolder holder, int position) {
        holder.onBindSliderImage(sliderImages[position]);
    }
    ...
    public static class ImageSliderViewHolder extends RecyclerView.ViewHolder {
        ...
        public void onBindSliderImage(String imageURL) {
